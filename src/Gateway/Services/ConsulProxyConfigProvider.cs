...
namespace Gateway.Services
{
  ...
  // bu arkadaş gidip consul agent servise bağlanıp kaç tane ms kendini register ettiyse onları bulup kendi üzerinde dinamik olarak bir yönelndirme kuralı tanımlamak.
